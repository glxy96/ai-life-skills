...
5. **Wikilink EVERYTHING** — people, places, companies, concepts, technical terms, **book/film/show titles**, even if no note exists yet. Wikilink nouns that name a **specific thing worth looking up**: proper nouns, technical/specialized terms, named concepts (socioeconomic, occupational, cultural, artistic). **Do NOT wikilink**: emotions (happiness, anxiety, hope…), adjectives, verbs, or words a general reader would never search for.
